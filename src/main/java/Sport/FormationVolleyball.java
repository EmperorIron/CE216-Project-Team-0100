...
public class FormationVolleyball extends Formation {
    ...
    public static final List<String> BALANCED_FORMATIONS    = Arrays.asList("5-1", "6-2");
    public static final List<String> ATTACKING_FORMATIONS   = Arrays.asList("6-2", "4-2");
    public static final List<String> DEFENSIVE_FORMATIONS   = Arrays.asList("5-1", "4-2");
